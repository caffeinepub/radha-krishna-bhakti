...
export class Backend implements backendInterface {
    ...
    async addFavoritePrayer(arg0: FavoriteId): Promise<[string, Array<FavoriteId>]> {
        if (this.processError) {
            try {
                const result = await this.actor.addFavoritePrayer(arg0);
                return [
                    result[0],
                    result[1]
                ];
    ...
    async addFavoriteQuote(arg0: FavoriteId): Promise<[string, Array<FavoriteId>]> {
        if (this.processError) {
            try {
                const result = await this.actor.addFavoriteQuote(arg0);
                return [
                    result[0],
                    result[1]
                ];
    ...
    async removeFavoritePrayer(arg0: FavoriteId): Promise<Array<FavoriteId>> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFavoritePrayer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFavoriteQuote(arg0: FavoriteId): Promise<Array<FavoriteId>> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFavoriteQuote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
